...
<template>
  <aside
    id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-[#341d08] border-r border-gray-200 sm:translate-x-0 dark:bg-[#341d08] dark:border-gray-700"
    aria-label="Sidebar"
  >
    <div class="h-full flex flex-col px-3 pb-4 bg-[#341d08] dark:bg-[#341d08]">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <button
          @click="handleLogout"
          class="flex items-center p-2 bg-[#341d08] rounded-lg dark:text-white dark:hover:bg-[#341d08] group w-100%"
        >
          <svg
            class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            aria-hidden="true"
